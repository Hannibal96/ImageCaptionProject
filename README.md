...
### Ecaluation & Results
We will use the bleu score from [the nltk package](https://www.nltk.org/_modules/nltk/translate/bleu_score.html) to evaluate the captions generated by our model.
